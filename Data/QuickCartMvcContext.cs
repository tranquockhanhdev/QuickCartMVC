...
public partial class QuickCartMvcContext : DbContext
{
	public QuickCartMvcContext()
	{
	}

	public QuickCartMvcContext(DbContextOptions<QuickCartMvcContext> options)
		: base(options)
	{
	}
	...
	//        => optionsBuilder.UseSqlServer("Data Source=DESKTOP-H2FCUH0\\PC;Initial Catalog=QuickCartMVC;Integrated Security=True;Connect Timeout=30;Encrypt=True;Trust Server Certificate=True;Application Intent=ReadWrite;Multi Subnet Failover=False");
